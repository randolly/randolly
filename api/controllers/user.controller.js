...
// exports.linkUserAccounts = async (req, res, next) => {
//     try {
//         let user = req.user
//         assert.ok(user)
//         // encrpt.encrypt(req.body)
//         let checkNullity =  (value) => {
//             // check if value is null else encrypt or return
//             if (value !== null || value !== undefined ){
//                 console.log(value)
//                 return encrpt.encrypt(value)
//             }else{
...
//             }
//         }
//         let { fb_token, fb_pageId, fb_pageAccessToken, ig_username, ig_password, tw_access_token, tw_access_token_secret } = req.body

//         fb_token = checkNullity(fb_token);
//         fb_pageId = checkNullity(fb_pageId)
//         fb_pageAccessToken = checkNullity(fb_pageAccessToken)
//         ig_username = checkNullity(ig_username)
//         ig_password = checkNullity(ig_password)
//         tw_access_token_secret = checkNullity(tw_access_token_secret)
//         tw_access_token = checkNullity(tw_access_token)

//         // let linked_socials = {
//         //     facebook: { 
//         //         fb_token: encrpt.encrypt(fb_token),
//         //         fb_pageId: encrpt.encrypt(fb_pageId),
//         //         fb_pageAccessToken: encrpt.encrypt(fb_pageAccessToken),
//         //      },
//         //      instagram: {
//         //         ig_username: encrpt.encrypt(ig_username),
//         //         ig_password: encrpt.encrypt(ig_password),
//         //      },
//         //     twitter: {
//         //         tw_access_token: encrpt.encrypt(tw_access_token),
//         //         tw_access_token_secret: encrpt.encrypt(tw_access_token_secret),
//         //     }
//         // }
//         user = await User.findByIdAndUpdate(user._id, {
//             $set: {
...
//         }
//         else
//             throw Error('error in linking accounts')
//     } catch (err) {
//         next(err)
//     }
// }
