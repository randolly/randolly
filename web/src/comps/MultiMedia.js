...
function MM(props) {
    ...
    if (url) {
        ...
        // />
        url = <Microlink url={url.expanded_url} autoPlay={false} media={['video', 'audio', 'iframe', 'screenshot', 'image', 'logo']} controls loop muted={false} style={{ width:"100%"}} lazy={{ threshold: 0.5 }}/>
        //props bellow
        // media='logo'
    }
    if (photo || url)
