...
import { Row, Col, Figure, Dropdown } from "react-bootstrap";
...
export default (props) => {
  ...
  let { post_detail_status: status, post_replies_status } = useSelector(
    (state) => state.posts
  );
  useEffect(() => {
          ...
          <div className="ml-auto d-lg-flex justify-content-end ">
            <Dropdown className="bg-clear high-index1">
              <Dropdown.Toggle
                ...
                id="comment-dropdown"
              >
                <FontAwesomeIcon className="m-2" size="xs" icon={faEllipsisH} />
              </Dropdown.Toggle>
        ...
        <Row className="border-top border-bottom d-flex p-2">
          <div className="py-1 pr-3">
            <span className="font-weight-bold mr-1">
              {numFormatter(post.favorite_count)}
            </span>
          ...
          <div className="py-1 pr-3">
            <span className="font-weight-bold mr-1">
              {numFormatter(post.retweet_count)}
            </span>
