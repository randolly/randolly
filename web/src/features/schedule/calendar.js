...
if (schedules.length > 0){
    myEventsList = schedules.map(schedule => ({start: schedule.schedule, end: schedule.schedule, title: schedule.text, description: schedule.text, date1: schedule.yymmdd}))
