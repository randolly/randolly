...
<br/>
                ...
                {list.map(itm => {
                    ...
                    let badge = itm.count ? <><Badge className="position-absolute" variant="primary" style={{ top: 5, right: 'unset', left: 'unset' }}>{itm.count}</Badge><span className="sr-only">new items</span></> : null
