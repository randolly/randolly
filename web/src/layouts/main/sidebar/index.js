    ...
    return (
        <Col>
            ...
            {!(location.pathname === '/explore/users') ?
                <FollowCard compact className="my-3" length={5} title='People' /> : undefined}
            {/* <br /> */}
            {!(location.pathname === '/explore') ?
                <TrendingCard className="my-3" title='Trend' /> : undefined}
            <footer className="m-2 mt-3 overflow-hidden">
                ...
                <div className="text-muted mb-1 mt-n1"><small>@rando</small></div>
            </footer>
        </Col>
    )
}
